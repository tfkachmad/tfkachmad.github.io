...
excerpt: "This project is my attempt to solve the first case study from the
Google Data Analytics Professional Certificate Capstone Projects on Coursera."
...
I really enjoy working on this project because not like other data
projects I have ever solved before. The challenge on this project is
ranging from the size of the data provided, to the working on how to
